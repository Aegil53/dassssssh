...
def analyzefile(input_file, output_dir):
    ...
    with open(output_file, 'w', newline="") as csvfile:
        fieldnames = ['Sentence ID', 'Sentence', 'Sentiment', 'Sentiment Label', 'Valence', 'Arousal']
        ...
        for line in fulltext:
            ...
            '''Valence = 0
            Arousal = 0
            if sentiment in range(-0.75, -1):
                Valence = -0.9
                Arousal = -0.1
            elif sentment in range(-0.5, -0.74):
                Valence = -0.7
                Arousal = -0.2
            elif sentment in range(-0.25, -0.49):
                Valence = -0.8
                Arousal = -0.3
            elif sentment in range(-0.01, -0.24):
                Valence = 0.5
                Arousal = -0.1
            elif sentment in range(0, 2.5):
                Valence = 0
                Arousal = 0
            elif sentment in range(0.26, 0.5):
                Valence = 0.3
                Arousal = 0.4
            elif sentment in range(0.51, 0.74):
                Valence = 0.2
                Arousal = 0.1
            elif sentment in range(0.75, 1):
                Valence = 0.4
                Arousal = 0.2'''
